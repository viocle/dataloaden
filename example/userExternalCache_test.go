...
func TestUserLoaderExternalCache(t *testing.T) {
	// simple example use of an external cache storage instead of the internal one used by the loader.
	// this can be a local/global variable, external database or redis, etc.
	var fetches [][]string
